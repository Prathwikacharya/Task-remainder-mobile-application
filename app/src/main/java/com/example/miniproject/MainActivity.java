...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCreateRem = (FloatingActionButton) findViewById(R.id.create_reminder); // Floating action button to change
        // activity
        ...
        Cursor cursor = new dbManager(getApplicationContext()).readAllReminders(); // Cursor To Load data From the
        // database
